...
////////////// CONSTRUCTOR //////////////////
	...
	void Bureaucrat::signForm(AForm & form)
	{
		...
		{
			std::cout << RED << this->_name << " couldn't sign "
	...
	void Bureaucrat::executeForm(AForm const & form) const
	{
		try {
			...
			std::cerr << RED << this->_name << " coudn't execute form " << form.getName()
		...
		catch (const std::ios_base::failure & e) 		// exception de ostream
		{
    	    std::cerr << RED << e.what() << ": can't open file" << RESET << std::endl;
		}
	}
